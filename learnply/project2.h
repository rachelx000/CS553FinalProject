...
private:
    ...
    std::vector<PolyLine> crit_contour;
...
public:
    ...
    void calcSpacedContours(int num);

    void drawCriticalPoints(bool use_height = false);
    void drawCrtitContours(bool use_height = false);
    void drawUserContour(bool use_height = false);
    void drawSpacedContours(bool use_heigh = false);
